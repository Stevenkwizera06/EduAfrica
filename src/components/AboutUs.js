    ...
    <div>
      ...
      <Wrapper>
        ...
        <div className="grid lg:grid-cols-2 lg:p-16 gap-8">
          ...
          <div>
            <img
              className="object-cover w-full lg:h-[293px]"
              alt=""
      ...
      <Wrapper>
        <div className="grid lg:grid-cols-2 lg:p-16 gap-8">
          <img
            className="object-contain order-2 lg:order-1"
          ...
          <div className="flex flex-col gap-4 order-1 lg:order-2">
            ...
            <p className="max-w-[470px] min-h-[192px]">
      ...
      <Wrapper>
        ...
        <div className="grid lg:grid-cols-2 mt-4 ">
          ...
          <div className="flex flex-col items-center text-center gap-6 bg-[#ecdc01] p-[30px]">
            <h1 className="text-5xl text-[#2e2e2e] text-[30px] font-[700] leading-[36px] text-center py-2.5">
              Our mission
            </h1>
            ...
            <h1 className="text-5xl text-[#2e2e2e] text-[30px] font-[700] leading-[36px] text-center">
              Our vision
            </h1>
            <p className="text-[#707070] max-w-[480px] leading-[28.8px] font-[500]">
